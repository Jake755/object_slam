...
public:
    ...
    cv::Mat raw_img;
    cv::Mat raw_color; // lin755
    std::vector<yolact::Object> yolact_objs;

    // 是否已创建物体
    bool IsCreatedObjs=false;
    // LocalMapping是否处理过
    bool IsLocalMapperProccessed=false;
    bool inLocalMappingLater=false;
