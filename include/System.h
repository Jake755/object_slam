...
class System
{
  ...
  public:
    ...
    System(const std::string &strVocFile, const std::string &strSettingsFile, const string &strYoloModelPath, const eSensor sensor, bool use_loop_closing = true);
